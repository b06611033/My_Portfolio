    ...
    <section id="experience" className="text-white bg-black body-font">
      <div className="container px-5 py-10 mx-auto  lg:px-80">
        ...
        <div className="flex flex-col">
          <h1 className="sm:text-2xl text-2xl font-medium text-left title-font mb-4 text-white">
            Software Engineer
          </h1>
          <p className="mb-8 leading-relaxed text-white">
            I joined NetApp as a software engineer in 2024 September.<br />
            I am in the Metrocluster team and is working on disaster/failure recovery solutions
        ...
        <div className="flex flex-col">
          ...
          <p className="mb-8 leading-relaxed text-white">
            ...
            During my internship, I developed a text extraction tool to identify keywords from images
            and built an inventory application to manage items in the database.<br />
        ...
        <div className="flex flex-col">
          ...
          <p className="mb-8 leading-relaxed text-white">
            I joined the Biophotonics and Bioimaging Laboratory of National Taiwan University as an undergraduate researcher, 
            where I worked on several image processing and machine learning projects.<br />
